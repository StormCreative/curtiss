...
class Has_one extends Relationships
{
    ...
    public function build_relationship()
    {
        ...
        foreach($this->associations as $one) {
            ...
            if( !!$one ) {
                ...
                if( !!$parts[1] && $parts[1] == 'image' ) {
                    $has_image = TRUE;
                }

                if( !!$parts[1] && $parts[1] == 'upload' ) {
                    $has_upload = TRUE;
                }

                $table = strtolower(DB_SUFFIX . '_' . $parts[0] );
                ...
                $this->get_has_one_columns($parts[0], $has_image, $has_upload);
            }
        }
     ...
     * @return void
     */
    public function get_has_one_columns($table, $has_image = FALSE, $has_upload = FALSE)
    {
