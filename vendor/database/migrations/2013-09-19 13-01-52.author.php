...
class build_author extends base_build
{
    private $_builder;
    ...
    public function __Construct ( $db_name, $tablename )
    {
        ...
        $this->_build = new query_builder ( $db_name, "author" );
    }

    public function put ()
    {
        $this->_build->create_table ( "author" );
    ...
    {
        $table_exists = mysql_query ( "SHOW TABLES LIKE 'giles_wilson_author'" );
...
$build = new build_author ( $this->_db_name, "author" );
$build->desc ();
