...
class build_category extends base_build
{
    private $_builder;
    ...
    public function __Construct ( $db_name, $tablename )
    {
        ...
        $this->_build = new query_builder ( $db_name, "category" );
    }

    public function put ()
    {
        $this->_build->create_table ( "category" );
    ...
    {
        $table_exists = mysql_query ( "SHOW TABLES LIKE 'giles_wilson_category'" );
...
$build = new build_category ( $this->_db_name, "category" );
$build->desc ();
