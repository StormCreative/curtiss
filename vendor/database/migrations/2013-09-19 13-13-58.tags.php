...
class build_tags extends base_build
{
    private $_builder;
    ...
    public function __Construct ( $db_name, $tablename )
    {
        ...
        $this->_build = new query_builder ( $db_name, "tags" );
    }

    public function put ()
    {
        $this->_build->create_table ( "tags" );
    ...
    {
        $table_exists = mysql_query ( "SHOW TABLES LIKE 'giles_wilson_tags'" );
...
$build = new build_tags ( $this->_db_name, "tags" );
$build->desc ();
